...
const days = ["Martes", "Jueves", "Sábado"]
...
const steps = [
  ...
  },
  {
    ...
    description: "Realiza el pago de $65.000 COP para asegurar tu bloque.",
            ...
            >
              ...
              <div className="mt-8 p-4 rounded-2xl bg-amber-500/10 border border-amber-500/20 flex gap-3.5 items-start">
                ...
                <p className="text-xs sm:text-sm text-foreground font-semibold leading-relaxed">
                  <strong className="text-amber-700 font-extrabold">Importante:</strong> Para confirmar y bloquear de manera definitiva tu espacio reservado en la agenda clínica, se requiere un abono inicial de <span className="text-primary font-black">$65.000 COP</span>.
                </p>
              </div>
            </form>
          </div>

...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-[#F5F8FB] bg-grid-pattern pt-24 pb-16 lg:pt-32 lg:pb-24">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="relative z-10 text-center lg:text-left lg:col-span-7 animate-fade-in-up">
            ...
            <h1 className="font-heading text-4xl sm:text-5xl lg:text-[54px] font-black tracking-tight text-foreground leading-[1.08] text-balance">
            ...
            <div className="mt-10 p-5 rounded-2xl bg-white border-l-4 border-[#E63946] shadow-premium max-w-lg mx-auto lg:mx-0 transition-all hover:scale-[1.01] duration-300">
